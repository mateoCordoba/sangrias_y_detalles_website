...
var styleURL =  './'; //En esta variable se almacena la ruta al archivo css de la ./app

var fontsSRC = './src/fonts/**/*.*';
var fontsURL = './app/fonts/' ;


var jsSRC = './gulp-src/js/*.js';  // en esta variable guardamos todos los recursos estilo JS
var jsURL = './js/';
